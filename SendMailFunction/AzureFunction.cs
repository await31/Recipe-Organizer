...
public class AzureFunction {
    ...
    [DurableClient] IDurableOrchestrationClient starter, TraceWriter log) {
        ...
        var localExecutionDateTime = TimeZoneInfo.ConvertTimeFromUtc(executionDateTime.UtcDateTime, vietnamTimeZone);
        var localExecutionDateTimeUtc = TimeZoneInfo.ConvertTimeToUtc(localExecutionDateTime, vietnamTimeZone);
        ...
        await starter.StartNewAsync("SendMailOrchestrator", cronExpression, input);
